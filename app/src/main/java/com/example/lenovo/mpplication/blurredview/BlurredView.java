package com.example.lenovo.mpplication.blurredview;
...
public class BlurredView extends LinearLayout {
    ...
    private void setImageView() {
        ...
        findViewById(R.id.blurredview_shadow).setVisibility(VISIBLE);
    }
